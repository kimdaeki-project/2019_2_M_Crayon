...
public class kakaoTest {
	...
	private final static String K_REDIRECT_URI = "http://localhost/s5/login/kakaoLogin";
	...
	public static JsonNode getAccessToken(String autorize_code) {
	      ...
	      postParams.add(new BasicNameValuePair("client_id", "79b8046cf2bd6521bd22931ba801069a")); // REST API KEY
