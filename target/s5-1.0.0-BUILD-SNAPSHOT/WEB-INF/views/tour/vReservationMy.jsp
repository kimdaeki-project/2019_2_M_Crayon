				...
				<div class="table table-striped" style="margin-bottom: 150px;">
							...
							<div class="vr_wrap">
								...
								<c:forEach items="${list3}" var="vvo" varStatus="str">
									<form action="../pay/vkakaoPay" method="post" id="frm">
											...
											<c:if test="${vvo.ac eq '예약 확정 결제 대기'}">
												<div class=vr_wrap_mini>
													<input type="submit" value="예약 결제"  id="goMoney">
												</div>
											</c:if>	
											<c:if test="${vvo.ac ne '예약 확정 결제 대기'}">
												<div class=vr_wrap_mini>
													<input type="hidden" value="예약 결제"  id="goMoney" >
												</div>
											</c:if>	
